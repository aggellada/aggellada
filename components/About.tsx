...
export default function About() {
  return (
    <div
      id="about"
      className={`w-full text-sm md:text-xl min-h-screen justify-center relative px-8 md:px-12 lg:px-40 pb-22 text-zinc-100 bg-[#020617] flex flex-col gap-8 `}
    >
      ...
      <p>
        ...
        Computer Science at UPOU.{" "}
      </p>
      <p>
        I've always been passionate and curious about tech, and what drew me to
        development is the perfect mix of creativity, logic, and problem-solving
        — and I’ve been hooked ever since. What pushed me to transition into
        tech was a realization: this life is too short to not pursue endeavors
        that truly excites and motivates me. So I decided to take a leap of
        faith and trust God in His plans for me.
      </p>
      <p>
      ...
      <p>
        ...
        businesses, or underserved communities.
      </p>
      <p>
